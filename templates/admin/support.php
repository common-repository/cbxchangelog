...
?>
<div class="wrap cbx-chota cbxchangelog-page-wrapper cbxchangelog-support-wrapper" id="cbxchangelog-support">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h2></h2>
	            <?php do_action('cbxchangelog_wpheading_wrap_before', 'support'); ?>
                <div class="wp-heading-wrap">
                    ...
                    <div class="wp-heading-wrap-right pull-right">
	                    <?php do_action('cbxchangelog_wpheading_wrap_right_before', 'support'); ?>
                        <a href="<?php echo admin_url( 'edit.php?post_type=cbxchangelog&page=cbxchangelog-settings' ); ?>" class="button outline primary pull-right"><?php esc_html_e( 'Global Settings', 'cbxchangelog' ); ?></a>
	                    <?php do_action('cbxchangelog_wpheading_wrap_right_after', 'support'); ?>
                    </div>
                </div>
	            <?php do_action('cbxchangelog_wpheading_wrap_after', 'support'); ?>
            </div>
        </div>
        <div class="row">
            <div class="col-6">
                <div class="cbx-backend-card">
                    <div class="header">
                        <div class="text">
                            <h2><?php esc_html_e( 'Get Free & Pro Addons', 'cbxchangelog' ); ?></h2>
                        </div>
                    </div>
                    <div class="content">
                        <div class="row">
                                    ...
                                    <div class="feature-card-body static">
                                        <div class="feature-card-header">
                                            <a href="<?php echo esc_url( $plugin_url ); ?>"
                                               target="_blank"> <img src="https://codeboxr.com/wp-content/uploads/productshots/9840-profile.png"
                                                                     alt="CBX Changelog for WordPress"/> </a>
                ...
                <div class="cbx-backend-card dashboard-plugin-Integration">
                    <div class="header">
                        <div class="text">
                            <h2><?php esc_html_e( 'Third Party plugin Integration', 'cbxchangelog' ); ?></h2>
                        </div>
                    </div>
                    <div class="content">
                        <div class="cbx-backend-settings-row">
                            <!--<p>
								...
								<?php /*esc_html_e( 'Coming Soon ...', 'cbxchangelog' ); */?></p>-->
                            <ul>
                                <li>Dokan</li>
                                <li>Woocommerce</li>
                ...
                <div class="cbx-backend-card dashboard-changelog">
                    <div class="header">
                        <div class="text">
                            <h2><?php esc_html_e( 'Changelog Core Plugin', 'cbxchangelog' ); ?></h2>
                        </div>
                    </div>
                    <div class="content">
                        <div class="cbx-backend-settings-row">
                        ...
                        <div class="cbx-backend-settings-row">
                            <p>Version - 1.1.2</p>
                            <ul>
                                <li>[improvement] PHP 8.x support<li>
                                <li>[updated] Pro addon new version released with Dokan plugin support<li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="cbx-backend-card dashboard-changelog">
                    <div class="header">
                        <div class="text">
                            <h2><?php esc_html_e( 'Changelog Pro Addon', 'cbxchangelog' ); ?></h2>
                        </div>
                    </div>
                    <div class="content">
                        <div class="cbx-backend-settings-row">
                            ...
                            <div class="cbx-backend-settings-row">
                                ...
                                <ul>
                                    <li>[fixed] Disable the Import/Export button from "Helps & Updates" page<li>
                                </ul>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <p>
                                ...
                                <ul>
                                    <li>[improvements] PHP 8.x support<li>
                                    <li>[new] Dokan plugin integration<li>
                                </ul>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <p>
                                ...
                                <ul>
                                    <li>[improvements] Improvements and bug fixes</li>
                                    <li>[updated] Export import of setting and individual changelog are improved</li>
                                </ul>
            ...
            <div class="col-6">
                <div class="cbx-backend-card dashboard-support">
                    <div class="header">
                        <div class="text">
                            <h2><?php esc_html_e( 'Help & Supports', 'cbxchangelog' ); ?></h2>
                        </div>
                    </div>
                    <div class="content">
                        <div class="cbx-backend-settings-row">
                        ...
                        <div class="cbx-backend-settings-row">
                            <a href="<?php echo esc_url( $doc_url ); ?>" target="_blank">
                                ...
                                <?php esc_html_e( 'Documentation & User Guide', 'cbxchangelog' ); ?> </a>
                        </div>
                        <div class="cbx-backend-settings-row">
                            <a href="https://wordpress.org/support/plugin/cbxchangelog/reviews/#new-post" target="_blank">
                                <svg viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <?php esc_html_e('Review & Rate CBX Bookmark Plugin', 'cbxchangelog'); ?> </a>
                        </div>
                        <div class="cbx-backend-settings-row">
                            <a href="https://wordpress.org/support/plugin/cbxchangelog/" target="_blank">
                                ...
                                <?php esc_html_e('Core Plugin Support', 'cbxchangelog'); ?></a>
                        </div>
                        <div class="cbx-backend-settings-row">
                            <a href="https://codeboxr.com/contact-us" target="_blank">
                                ...
                                <?php esc_html_e('Pro Addon Support', 'cbxchangelog'); ?></a>
                        </div>
                    </div>
                </div>
                <div class="cbx-backend-card dashboard-wp-plugin">
                    <div class="header">
                        <div class="text">
                            <h2><?php esc_html_e( 'Other WordPress Plugins', 'cbxchangelog' ); ?></h2>
                        </div>
                    </div>
                    <div class="content">
                        <?php
                ...
                <div class="cbx-backend-card dashboard-wp-plugin">
                    <div class="header">
                        <div class="text">
                            <h2><?php esc_html_e( 'Codeboxr News Updates', 'cbxchangelog' ); ?></h2>
                        </div>
                    </div>
                    <div class="content">
						<?php
